      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-[350px_1fr] lg:grid-cols-[400px_1fr] gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-12">
            ...
            >
              <h3 className="font-serif text-2xl md:text-3xl mb-4 text-foreground">A Note From Us</h3>
              <p className="text-base text-muted-foreground leading-relaxed text-pretty">
                We are excited to start this new chapter of our lives together, surrounded by the people we
